...
class ExtractDirectiveBase(SphinxDirective):
...
def make_extract_directive_class() -> type[ExtractDirectiveBase]:
    cls = type('ExtractDirective', (ExtractDirectiveBase,), dict(deprecations=[]))
    return cast(type[ExtractDirectiveBase], cls)
